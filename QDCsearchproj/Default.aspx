                ...
                <div id="facetPanel" class="col-sm-3 col-md-3 sidebar collapse" style="background-color:white">
                    ...
                    <ul class="nav nav-sidebar">
                         <div className="panel panel-primary behclick-panel">
                            ...
                            <li>
                                <div id="MainSpec/HeaderFacet">
                                </div>
                            </li>
                            <li>
                                <div id="MainSpec/BodyFacet">
                                </div>
                            </li>
                            <li>
...
<script>
    ...
    var automagic = new AzSearch.Automagic({ index: "bs-index", queryKey: "2FAC1447E6DA3A4751208C739FF977F0", service: "azureqoiprsearch" });
    ...
    const resultTemplate = `<div class="col-xs-12 col-sm-3 col-md-3 result_img" >
        ...
        </div><div class="col-xs-12 col-sm-9 col-md-9"><h4>{{StdDescription}}</h4><div class="resultDescription"><a href="@search.text">{{{MfPN}}}</a>&emsp;&emsp;<a href="@search.text">Show price</a></div></div>`;
    ...
    var suggestionsTemplate = `
            <p> {{Category}} </p>
            <p> {{ProductLine}} </p> {{{searchText}}}`;

    // Add a search box that uses suggester "bs-suggest", grabbing some additional fields to display during suggestions. Use the template defined above
    automagic.addSearchBox("searchBox",
        {
            highlightPreTag: "<b>",
            highlightPostTag: "</b>",
            suggesterName: "bs-suggest",
            select: "Category,ProductLine"
        },
        "",
        suggestionsTemplate);
    ...
    automagic.addCheckboxFacet("MainSpec/HeaderFacet", "MainSpec/Header", "string");
    automagic.addCheckboxFacet("MainSpec/BodyFacet", "MainSpec/Body", "string");
